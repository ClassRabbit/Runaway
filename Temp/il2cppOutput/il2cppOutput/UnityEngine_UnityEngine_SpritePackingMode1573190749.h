...
struct  SpritePackingMode_t1573190749 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SpritePackingMode_t1573190749, ___value___1)); }
