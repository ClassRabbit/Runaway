...
#include "UnityEngine_UnityEngineInternal_WebRequestUtils4281919736MethodDeclarations.h"
...
extern const uint32_t WebRequestUtils_RedirectTo_m914411020_MetadataUsageId;
extern "C"  String_t* WebRequestUtils_RedirectTo_m914411020 (Il2CppObject * __this /* static, unused */, String_t* ___baseUri0, String_t* ___redirectUri1, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
		il2cpp_codegen_initialize_method (WebRequestUtils_RedirectTo_m914411020_MetadataUsageId);
		s_Il2CppMethodIntialized = true;
	}
	Uri_t1116831938 * V_0 = NULL;
	Uri_t1116831938 * V_1 = NULL;
	...
	}
	{
		...
		Uri_t1116831938 * L_3 = (Uri_t1116831938 *)il2cpp_codegen_object_new(Uri_t1116831938_il2cpp_TypeInfo_var);
		Uri__ctor_m2903273618(L_3, L_2, 2, /*hidden argument*/NULL);
		V_0 = L_3;
		goto IL_0023;
	}
...
IL_001b:
	{
		...
		Uri__ctor_m2903273618(L_5, L_4, 0, /*hidden argument*/NULL);
		V_0 = L_5;
	}

IL_0023:
	{
		Uri_t1116831938 * L_6 = V_0;
		NullCheck(L_6);
		bool L_7 = Uri_get_IsAbsoluteUri_m145672153(L_6, /*hidden argument*/NULL);
		if (!L_7)
		{
			goto IL_0030;
		}
...
IL_0030:
	{
		...
		Uri_t1116831938 * L_10 = (Uri_t1116831938 *)il2cpp_codegen_object_new(Uri_t1116831938_il2cpp_TypeInfo_var);
		Uri__ctor_m2903273618(L_10, L_9, 1, /*hidden argument*/NULL);
		V_1 = L_10;
		Uri_t1116831938 * L_11 = V_1;
		Uri_t1116831938 * L_12 = V_0;
		Uri_t1116831938 * L_13 = (Uri_t1116831938 *)il2cpp_codegen_object_new(Uri_t1116831938_il2cpp_TypeInfo_var);
		Uri__ctor_m3078326711(L_13, L_11, L_12, /*hidden argument*/NULL);
		V_2 = L_13;
		Uri_t1116831938 * L_14 = V_2;
		NullCheck(L_14);
